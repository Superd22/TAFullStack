/**
 * 21/10/2017: Sendbird definitions are currently broken and un-usable, 
 * see https://github.com/smilefam/SendBird-SDK-JavaScript/issues/43
 * 
 * this is a temporary work-around.
 */


export interface SendBirdStatic {
    version: number;
    new({ 'appId': string }): SendBirdInstance;
}

export type userCallback = (user: User, error: Object) => void;
export type pushSettingCallback = (response: string, error: Object) => void;
export interface SendBirdInstance {
    currentUser: User;
    User: UserStatic;
    Member: MemberStatic;
...
export interface ChannelHandlerStatic {
    new(): ChannelHandler;
}
...
export interface ConnectionHandlerStatic {
 ...
 * Message
 */
export interface BaseMessageInstance {
    channelUrl: string;
    channelType: string;
    messageId: number;
    message: string;
...
export interface AdminMessage extends BaseMessageInstance {
    translations: Object;
}
export interface AdminMessageStatic {
    buildFromSerializedData(serializedObject: Object): AdminMessage;
}

export interface UserMessage extends BaseMessageInstance {
    sender: User;
    reqId: string;
    translations: Object;
}
export interface UserMessageStatic {
    buildFromSerializedData(serializedObject: Object): UserMessage;
}

export interface FileMessage extends BaseMessageInstance {
    sender: User;
    reqId: string;
    url: string;
    name: string;
...
export interface FileMessageStatic {
 ...
 * Channel
 */
export type messageCallback = (message: UserMessage | FileMessage, error: Object) => void;
export type cancelUploadingFileMessageCallback = (isSuccess: boolean, error: Object) => void;
export type fileUploadprogressHandler = (event: Object) => void;
export type messageChangeLogs = {
    updatedMessages: Array<UserMessage | FileMessage | AdminMessage>,
    deletedMessageIds: Array<string>,
    hasMore: boolean,
    token: string
}
export type getMessageChangeLogsByTokenHandler = (data: messageChangeLogs, error: Object) => void;
...
export interface MessageListQuery { /* Deprecated */
 ...
 * OpenChannel
 */
export type commonCallback = (response: Object, error: Object) => void;
export type openChannelCallback = (openChannel: OpenChannel, error: Object) => void;
...
export type userListQueryCallback = (userList: Array<User>, error: Object) => void;
...
export interface OpenChannelStatic {
...
export type openChannelListQueryCallback = (openChannelList: Array<OpenChannel>, error: Object) => void;
export interface OpenChannelListQuery {
    limit: number;
    hasNext: boolean;
    nameKeyword: string;
    urlKeyword: string;
...
export interface GroupChannelStatic {
    buildFromSerializedData(serializedObject: Object): OpenChannel;
